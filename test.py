...
def save_transcription():
    ...
    if file_path:
        with open(file_path, 'w') as file:
            file.write(output_text.value)  # Assicurati che output_text contenga il testo della trascrizione
...
with gr.Blocks() as demo:
    ...
    save_button = gr.Button("Save Transcript", variant="primary")  # Aggiungi il pulsante di salvataggio
    ...
    save_button.click(
        save_transcription,  # Call the save function
        inputs=[],  # No inputs
        outputs=[]  # No outputs
    )
