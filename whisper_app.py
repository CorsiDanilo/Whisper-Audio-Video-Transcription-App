...
#         segments, info = batched_model.transcribe(file_path, batch_size=8, language=language, beam_size=beam_size, condition_on_previous_text=condition_on_previous_text, word_timestamps=word_timestamps)
