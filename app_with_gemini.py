...
pyinstaller app_with_gemini.py --collect-data gradio --collect-data gradio_client --additional-hooks-dir=./hooks --runtime-hook ./runtime_hook.py --noconfirm --icon=logo.ico --distpath=./dist/whisper_with_cmd --name=Whisper
pyinstaller app_with_gemini.py --collect-data gradio --collect-data gradio_client --additional-hooks-dir=./hooks --runtime-hook ./runtime_hook.py --noconsole --noconfirm --icon=logo.ico --distpath=./dist/whisper_no_cmd --name=Whisper
...
from whisper_app_with_gemini import demo as whisper_app_with_gemini 

whisper_app_with_gemini.launch(prevent_thread_lock=True)

webview.create_window("🎙️ Whisper Audio/Video Transcription App", whisper_app_with_gemini.local_url)
webview.start()